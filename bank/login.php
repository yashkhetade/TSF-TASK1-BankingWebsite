...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 22pt;"><kbd>Presented by:Yash Khetade</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
